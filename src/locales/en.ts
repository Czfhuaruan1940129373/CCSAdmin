export default {
  ...
  login: {
    ...
    placeholderSignup: 'please input username',
  ...
  router: {
    ...
    caliResSearch: 'Calibration response search',
    devCaliResSearch: 'Devloper',
  ...
  caliFiles: {
    title: 'calibration measure file'
  },
  dataComparison: {
